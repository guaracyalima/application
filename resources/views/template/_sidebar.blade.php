    ...
    <ul class="side-menu-list">
        ...
        <li class="blue with-sub">
	            <span>
	                ...
	                <span class="lbl">Pessoas</span>
	            </span>
            <ul>
                <li>
                    <a href="{{ route ('candidates') }}">
                        <span class="lbl">Candidatos</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route ('colaborator') }}">
                        <span class="lbl">Colaboradores</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route ('voters') }}">
                        <span class="lbl">Eleitores</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="pink-red">
            <a href="{{ route ('packages') }}" >
                ...
                <span class="lbl">Pacotes</span>
            </a>
        </li>

        <li class="pink-red">
            <a href="{{ route('occupations') }}" >
                <i class="fa fa-user-md" aria-hidden="true"></i>
                <span class="lbl">Profissoes</span>
            </a>
        </li>

        <li class="pink-red">
            <a href="{{ route('schooling') }}" >
                <i class="fa fa-graduation-cap" aria-hidden="true"></i>
                <span class="lbl">Escolaridades</span>
            </a>
        </li>
        ...
        <li class="grey with-sub">
	            <span>
	                ...
	                <span class="lbl">Teritorios</span>
	            </span>
            <ul>
                <li>
                    <a href=" {{ route ('teritories') }} ">
                        <span class="lbl">
                            Regioes
                        </span>
                    </a>
