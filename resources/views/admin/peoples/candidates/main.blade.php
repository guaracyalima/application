                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="fixed-table-toolbar"><div class="bars pull-left">
                                <div id="toolbar">
                                    <a class="btn btn-primary ks-rounded" href="{{ route('new_candidate') }}">
                                        Novo candidato
                                    </a>
                        ...
                        <table id="table-edit" class="table table-bordered table-hover">
                            ...
                            @foreach($candidates as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('show_candidates', ['id' => $item->id]) }}">{{ $item->politic_name }}</a>
                                    </td>
                                    <td>{{ $item->cpf }}</td>
                                    ...
                                    <td style="white-space: nowrap; width: 1%;">
                                        <div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                            <div class="btn-group btn-group-sm" style="float: none;">
                                                <a href="{{ route('show_candidates', ['id' => $item->id]) }}" class="tabledit-edit-button btn btn-sm btn-success" style="float: none;">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('edit_candidates', ['id' => $item->id]) }}" class="tabledit-edit-button btn btn-sm btn-warning" style="float: none;">
                                                    <span class="glyphicon glyphicon-pencil"></span>
                                                </a>

                                                <a href="{{ route('destroy_candidates', ['id' => $item->id]) }}" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;">
